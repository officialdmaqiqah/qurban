            ...
            tr.innerHTML = `
                ...
                <td>
                    <div style="display:flex; gap:5px; align-items:center;">
                        ...
                        ${isChecked ? '✅' : '<button class="btn btn-sm btn-verify-single" data-id="${item.id}" style="padding:2px 5px; font-size:0.6rem;">Check</button>'}
                        <button class="btn btn-sm btn-danger btn-quick-dead" data-id="${item.id}" style="padding:2px 5px; font-size:0.6rem;">💀 Mati/Hilang</button>
                    </div>
                </td>
            `;
