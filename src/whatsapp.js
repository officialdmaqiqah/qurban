...
const WA_DEFAULT_CONFIG = {
    ...
    templateDistribusiTerkirim: "*NOTIFIKASI PENGANTARAN QURBAN* 🚚\n==========================\n\nBismillahirrohmanirrohim.\n\nAssalamu’alaikum Warahmatullahi Wabarakatuh,\n\nKepada Yth. Bapak/Ibu *[[NAMA]]*,\n\nAlhamdulillah, kami ingin mengabarkan bahwa hewan qurban Anda (ID: *[[ID]]*) telah berhasil diantarkan dengan selamat dan diterima dalam kondisi baik.\n\n📌 *Detail Pengantaran:*\n- Tgl Antar: [[TGL]]\n- No. Kambing: *[[ITEMS]]*\n- Penerima: *[[NAMA]]*\n- Sisa Tagihan: *[[SISA]]*\n\nTerlampir di atas adalah foto bukti serah terima di lokasi sebagai dokumentasi amanah Anda. Semoga ibadah qurban Bapak/Ibu senantiasa diterima di sisi Allah SWT, mendatangkan keberkahan, serta kemaslahatan bagi sesama. Aamiin Yaa Robbal 'Alamin.\n\nJazakumullah Khairan Katsiran atas kepercayaan yang diberikan kepada kami.\n\nWassalamu’alaikum Warahmatullahi Wabarakatuh.\n\n[[FOOTER]]",
    templateDistribusiTerkirimAgen: "*NOTIFIKASI DISTRIBUSI SELESAI (UNTUK AGEN)* 📢\n==========================\n\nBismillah\nHalo Partner Terbaik, Agen *[[NAMA_AGEN]]*!\n\nMenginformasikan bahwa hewan qurban konsumen Anda telah berhasil terdistribusi:\n\n👤 *Data Konsumen:*\n- Nama Konsumen: *[[NAMA]]*\n- ID Transaksi: *[[ID]]*\n\n📌 *Detail Pengantaran:*\n- Tgl Antar: [[TGL]]\n- No. Kambing: *[[ITEMS]]*\n- Sisa Tagihan Konsumen: *[[SISA]]*\n\nTerlampir di atas adalah foto bukti serah terima dari petugas di lokasi. Silakan berkoordinasi kembali dengan konsumen Anda untuk menjaga silaturahmi. Terima kasih atas kerja keras Anda!\n\nSalam sukses,\n[[FOOTER]]",
...
export const getWaConfig = async () => {
    ...
    if (!config.templateDistribusiTerkirim || !config.templateDistribusiTerkirim.includes("Yth. Bapak/Ibu")) {
        config.templateDistribusiTerkirim = WA_DEFAULT_CONFIG.templateDistribusiTerkirim;
        configPatched = true;
    }
    if (!config.templateDistribusiTerkirimAgen) {
