...
const WA_DEFAULT_CONFIG = {
    ...
    templateDistribusiTerkirim: "*NOTIFIKASI PENGANTARAN QURBAN* 🚚\n==========================\n\nBismillahirrohmanirrohim.\n\nAssalamu’alaikum Warahmatullahi Wabarakatuh,\n\nKepada Yth. Bapak/Ibu *[[NAMA]]*,\n\nAlhamdulillah, kami ingin mengabarkan bahwa hewan qurban Anda telah berhasil diantarkan dengan selamat dan diterima dalam kondisi baik.\n\n👤 *Data Penerima / Konsumen:*\n- Nama Konsumen: *[[NAMA]]*\n- Alamat Tujuan: *[[ALAMAT]]*\n\n🐐 *Rincian Hewan Qurban:*\n- ID Transaksi: *[[ID]]*\n- *[[ITEMS]]*\n\n📷 *Bukti Serah Terima:*\n- Link Foto: [[BUKTI]]\n\n📌 *Status Tagihan:*\n- Sisa Tagihan: *[[SISA]]*\n\n⭐⭐⭐⭐⭐\n*SURVEY KEPUASAN PELAYANAN*\nBantu kami meningkatkan pelayanan dengan memberikan penilaian bintang & ulasan singkat pada tautan berikut:\n👉 https://dmqurban.com/survey.html?role=sohibul\n\nSemoga ibadah qurban Bapak/Ibu senantiasa diterima di sisi Allah SWT, mendatangkan keberkahan, serta kemaslahatan bagi sesama. Aamiin Yaa Robbal 'Alamin.\n\nJazakumullah Khairan Katsiran atas kepercayaan yang diberikan kepada kami.\n\nWassalamu’alaikum Warahmatullahi Wabarakatuh.\n\n[[FOOTER]]",
    templateDistribusiTerkirimAgen: "*NOTIFIKASI DISTRIBUSI SELESAI (UNTUK AGEN)* 📢\n==========================\n\nBismillah\nHalo Partner Terbaik, Agen *[[NAMA_AGEN]]*!\n\nMenginformasikan bahwa hewan qurban konsumen Anda telah berhasil terdistribusi:\n\n👤 *Data Konsumen:*\n- Nama Konsumen: *[[NAMA]]*\n- Alamat Tujuan: *[[ALAMAT]]*\n\n🐐 *Rincian Hewan Qurban:*\n- ID Transaksi: *[[ID]]*\n- *[[ITEMS]]*\n\n📷 *Bukti Serah Terima:*\n- Link Foto dari Sopir: [[BUKTI]]\n\n📌 *Status Tagihan Konsumen:*\n- Sisa Tagihan: *[[SISA]]*\n\nSilakan berkoordinasi kembali dengan konsumen Anda untuk menjaga silaturahmi. Terima kasih atas kerja keras Anda!\n\nSalam sukses,\n[[FOOTER]]",
    templateKonfirmasiKirim: "{Assalamu’alaikum Wr. Wb.|Bismillah, Assalamu'alaikum|Halo} Bapak/Ibu *[[NAMA]]*,\n\nKami dari Daarul Mahabbah Qurban {ingin mengonfirmasi kembali|ingin menginfokan|menyampaikan detail} rencana pengantaran hewan qurban Anda dengan rincian berikut:\n\n📌 *DETAIL PENGIRIMAN*\n- *No. Transaksi*: [[ID]]\n- *Jadwal Antar*: [[JADWAL]]\n- *Alamat Tujuan*: [[ALAMAT]]\n- *Google Maps*: [[MAPS]]\n\n🐐 *RINCIAN HEWAN & SOHIBUL*\n[[ITEMS]]\n\n*Nama Sohibul Qurban:*\n[[SOHIBUL]]\n\n🖼️ *Foto Fisik Hewan*:\n[[FOTO]]\n\n{Mohon dicek kembali|Silakan ditinjau kembali|Tolong diperiksa kembali} jadwal di atas. {Jika sudah sesuai, mohon balas pesan ini|Jika datanya sudah benar, harap balas chat ini dengan kata \"OK\"|Harap konfirmasi dengan membalas pesan ini jika sudah pas} ya agar tim kami bisa langsung menjadwalkannya. Terima kasih!\n\n[[FOOTER]]",
    templateKonfirmasiAmbil: "{Assalamu’alaikum Wr. Wb.|Bismillah, Assalamu'alaikum|Halo} Bapak/Ibu *[[NAMA]]*,\n\nKami dari Daarul Mahabbah Qurban {ingin mengonfirmasi kembali|ingin menginfokan|menyampaikan detail} pengambilan mandiri hewan qurban Anda dengan rincian berikut:\n\n📌 *DETAIL PENGAMBILAN*\n- *No. Transaksi*: [[ID]]\n- *Jadwal Ambil*: [[JADWAL]]\n- *Tempat Pengambilan*: [[ALAMAT]]\n\n🐐 *RINCIAN HEWAN & SOHIBUL*\n[[ITEMS]]\n\n*Nama Sohibul Qurban:*\n[[SOHIBUL]]\n\n🖼️ *Foto Fisik Hewan*:\n[[FOTO]]\n\n{Mohon dicek kembali|Silakan ditinjau kembali|Tolong diperiksa kembali} jadwal di atas. {Jika sudah sesuai, mohon balas pesan ini|Jika datanya sudah benar, harap balas chat ini dengan kata \"OK\"|Harap konfirmasi dengan membalas pesan ini jika sudah pas} ya. Terima kasih!\n\n[[FOOTER]]"
};
...
export const getWaConfig = async () => {
    ...
    if (!config.templateDistribusiTerkirim || !config.templateDistribusiTerkirim.includes("SURVEY KEPUASAN PELAYANAN")) {
        config.templateDistribusiTerkirim = WA_DEFAULT_CONFIG.templateDistribusiTerkirim;
        configPatched = true;
    }
    if (!config.templateDistribusiTerkirimAgen || !config.templateDistribusiTerkirimAgen.includes("Bukti Serah Terima")) {
        config.templateDistribusiTerkirimAgen = WA_DEFAULT_CONFIG.templateDistribusiTerkirimAgen;
        configPatched = true;
    }
    ...
    if (config.templateOrderDM && (config.templateOrderDM.includes("💰 Pembayaran") || config.templateOrderDM.includes("Harga Deal") || config.templateOrderDM.includes("Sisa Tagihan") || config.templateOrderDM.includes("Pembayaran") || config.templateOrderDM.includes("DP Dibayar") || config.templateOrderDM.includes("Sisa Tagihan:"))) {
        config.templateOrderDM = WA_DEFAULT_CONFIG.templateOrderDM;
        configPatched = true;
    }
    if (!config.templateKonfirmasiKirim) {
        config.templateKonfirmasiKirim = WA_DEFAULT_CONFIG.templateKonfirmasiKirim;
        configPatched = true;
    }
    if (!config.templateKonfirmasiAmbil) {
        config.templateKonfirmasiAmbil = WA_DEFAULT_CONFIG.templateKonfirmasiAmbil;
        configPatched = true;
    }
