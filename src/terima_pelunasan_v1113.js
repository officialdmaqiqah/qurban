            ...
            try {
                ...
                for (const trx of trxs) {
                    ...
                    let total = history.reduce((sum, h) => {
                        ...
                        if (h.tipe === 'pemasukan') {
                            // KRITIKAL: Abaikan kategori yang bukan pembayaran order (Titipan, Komisi, Jual Kambing, Karkas)
                            if (cat.includes('komisi') || cat.includes('karkas') || cat.includes('titipan') || cat.includes('jual kambing')) return sum;
