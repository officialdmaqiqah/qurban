            ...
            try {
                ...
                for (const trx of trxs) {
                    ...
                    let total = history.reduce((sum, h) => {
                        ...
                        if (h.tipe === 'pemasukan') {
                            // KRITIKAL: Abaikan Titipan, Komisi, Karkas, SULAM, TUMBAL
                            if (cat === 'titipan dana agen' || cat.includes('komisi') || cat.includes('karkas') || cat.includes('sulam') || cat.includes('tumbal')) return sum;
                            return sum + h.nominal;
                        } else {
                            // HANYA Refund/Pengembalian murni ke konsumen
