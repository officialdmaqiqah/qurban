...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (sidebar) {
        ...
        verTag.innerHTML = `System Version: <span style="color:var(--primary); font-weight:700;">v4.9 [LATEST]</span>`;
        sidebar.appendChild(verTag);
    }
    console.log("%c>> DMQ SYSTEM ACTIVE: v4.9 <<", "color: #10b981; font-weight: bold; font-size: 14px;");
});
